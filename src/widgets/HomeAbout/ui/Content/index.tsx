...
const Content: FC<Props> = ({ className }) => {
	return (
		<ul className={cn('flex flex-col gap-y-5', className)}>
			...
			<ContentItem>
				 Создаем цифровые продукты, которые помогают бизнесу расти,
				обеспечивая{' '}
				<UiTypography font='Montserrat-M' tag='span'>
			...
			<ContentItem>
				Мы используем  для повышения эффективности, 
				<UiTypography font='Montserrat-M' tag='span'>
				возможности искусственного интеллекта и нейросетевых технологий	{' '}
					индивидуальный подход
				</UiTypography>{' '}
				персонализации и интерактивности цифровых продуктов
			</ContentItem>
			<ContentItem>
				Мы нацелены на
				<UiTypography font='Montserrat-M' tag='span'>
